// architecture_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module architecture_mm_interconnect_0 (
		...
		output wire [1:0]  pi_s1_address,                           //                             pi_s1.address
		input  wire [31:0] pi_s1_readdata,                          //                                  .readdata
		output wire [1:0]  po_s1_address,                           //                             po_s1.address
		output wire        po_s1_write,                             //                                  .write
		input  wire [31:0] po_s1_readdata,                          //                                  .readdata
		output wire [31:0] po_s1_writedata,                         //                                  .writedata
		output wire        po_s1_chipselect,                        //                                  .chipselect
	...
	wire  [92:0] cmd_mux_001_src_data;                                                        // cmd_mux_001:src_data -> nios2_debug_mem_slave_agent:cp_data
	...
	wire  [31:0] pi_s1_agent_m0_readdata;                                                     // pi_s1_translator:uav_readdata -> pi_s1_agent:m0_readdata
	wire         pi_s1_agent_m0_waitrequest;                                                  // pi_s1_translator:uav_waitrequest -> pi_s1_agent:m0_waitrequest
	wire         pi_s1_agent_m0_debugaccess;                                                  // pi_s1_agent:m0_debugaccess -> pi_s1_translator:uav_debugaccess
	wire  [16:0] pi_s1_agent_m0_address;                                                      // pi_s1_agent:m0_address -> pi_s1_translator:uav_address
	wire   [3:0] pi_s1_agent_m0_byteenable;                                                   // pi_s1_agent:m0_byteenable -> pi_s1_translator:uav_byteenable
	wire         pi_s1_agent_m0_read;                                                         // pi_s1_agent:m0_read -> pi_s1_translator:uav_read
	wire         pi_s1_agent_m0_readdatavalid;                                                // pi_s1_translator:uav_readdatavalid -> pi_s1_agent:m0_readdatavalid
	wire         pi_s1_agent_m0_lock;                                                         // pi_s1_agent:m0_lock -> pi_s1_translator:uav_lock
	wire  [31:0] pi_s1_agent_m0_writedata;                                                    // pi_s1_agent:m0_writedata -> pi_s1_translator:uav_writedata
	wire         pi_s1_agent_m0_write;                                                        // pi_s1_agent:m0_write -> pi_s1_translator:uav_write
	wire   [2:0] pi_s1_agent_m0_burstcount;                                                   // pi_s1_agent:m0_burstcount -> pi_s1_translator:uav_burstcount
	wire         pi_s1_agent_rf_source_valid;                                                 // pi_s1_agent:rf_source_valid -> pi_s1_agent_rsp_fifo:in_valid
	wire  [93:0] pi_s1_agent_rf_source_data;                                                  // pi_s1_agent:rf_source_data -> pi_s1_agent_rsp_fifo:in_data
	wire         pi_s1_agent_rf_source_ready;                                                 // pi_s1_agent_rsp_fifo:in_ready -> pi_s1_agent:rf_source_ready
	wire         pi_s1_agent_rf_source_startofpacket;                                         // pi_s1_agent:rf_source_startofpacket -> pi_s1_agent_rsp_fifo:in_startofpacket
	wire         pi_s1_agent_rf_source_endofpacket;                                           // pi_s1_agent:rf_source_endofpacket -> pi_s1_agent_rsp_fifo:in_endofpacket
	wire         pi_s1_agent_rsp_fifo_out_valid;                                              // pi_s1_agent_rsp_fifo:out_valid -> pi_s1_agent:rf_sink_valid
	wire  [93:0] pi_s1_agent_rsp_fifo_out_data;                                               // pi_s1_agent_rsp_fifo:out_data -> pi_s1_agent:rf_sink_data
	wire         pi_s1_agent_rsp_fifo_out_ready;                                              // pi_s1_agent:rf_sink_ready -> pi_s1_agent_rsp_fifo:out_ready
	wire         pi_s1_agent_rsp_fifo_out_startofpacket;                                      // pi_s1_agent_rsp_fifo:out_startofpacket -> pi_s1_agent:rf_sink_startofpacket
	wire         pi_s1_agent_rsp_fifo_out_endofpacket;                                        // pi_s1_agent_rsp_fifo:out_endofpacket -> pi_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_003_src_valid;                                                       // cmd_mux_003:src_valid -> pi_s1_agent:cp_valid
	wire  [92:0] cmd_mux_003_src_data;                                                        // cmd_mux_003:src_data -> pi_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                       // pi_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [5:0] cmd_mux_003_src_channel;                                                     // cmd_mux_003:src_channel -> pi_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                               // cmd_mux_003:src_startofpacket -> pi_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                 // cmd_mux_003:src_endofpacket -> pi_s1_agent:cp_endofpacket
	wire  [31:0] po_s1_agent_m0_readdata;                                                     // po_s1_translator:uav_readdata -> po_s1_agent:m0_readdata
	wire         po_s1_agent_m0_waitrequest;                                                  // po_s1_translator:uav_waitrequest -> po_s1_agent:m0_waitrequest
	wire         po_s1_agent_m0_debugaccess;                                                  // po_s1_agent:m0_debugaccess -> po_s1_translator:uav_debugaccess
	wire  [16:0] po_s1_agent_m0_address;                                                      // po_s1_agent:m0_address -> po_s1_translator:uav_address
	wire   [3:0] po_s1_agent_m0_byteenable;                                                   // po_s1_agent:m0_byteenable -> po_s1_translator:uav_byteenable
	wire         po_s1_agent_m0_read;                                                         // po_s1_agent:m0_read -> po_s1_translator:uav_read
	wire         po_s1_agent_m0_readdatavalid;                                                // po_s1_translator:uav_readdatavalid -> po_s1_agent:m0_readdatavalid
	wire         po_s1_agent_m0_lock;                                                         // po_s1_agent:m0_lock -> po_s1_translator:uav_lock
	wire  [31:0] po_s1_agent_m0_writedata;                                                    // po_s1_agent:m0_writedata -> po_s1_translator:uav_writedata
	wire         po_s1_agent_m0_write;                                                        // po_s1_agent:m0_write -> po_s1_translator:uav_write
	wire   [2:0] po_s1_agent_m0_burstcount;                                                   // po_s1_agent:m0_burstcount -> po_s1_translator:uav_burstcount
	wire         po_s1_agent_rf_source_valid;                                                 // po_s1_agent:rf_source_valid -> po_s1_agent_rsp_fifo:in_valid
	wire  [93:0] po_s1_agent_rf_source_data;                                                  // po_s1_agent:rf_source_data -> po_s1_agent_rsp_fifo:in_data
	wire         po_s1_agent_rf_source_ready;                                                 // po_s1_agent_rsp_fifo:in_ready -> po_s1_agent:rf_source_ready
	wire         po_s1_agent_rf_source_startofpacket;                                         // po_s1_agent:rf_source_startofpacket -> po_s1_agent_rsp_fifo:in_startofpacket
	wire         po_s1_agent_rf_source_endofpacket;                                           // po_s1_agent:rf_source_endofpacket -> po_s1_agent_rsp_fifo:in_endofpacket
	wire         po_s1_agent_rsp_fifo_out_valid;                                              // po_s1_agent_rsp_fifo:out_valid -> po_s1_agent:rf_sink_valid
	wire  [93:0] po_s1_agent_rsp_fifo_out_data;                                               // po_s1_agent_rsp_fifo:out_data -> po_s1_agent:rf_sink_data
	wire         po_s1_agent_rsp_fifo_out_ready;                                              // po_s1_agent:rf_sink_ready -> po_s1_agent_rsp_fifo:out_ready
	wire         po_s1_agent_rsp_fifo_out_startofpacket;                                      // po_s1_agent_rsp_fifo:out_startofpacket -> po_s1_agent:rf_sink_startofpacket
	wire         po_s1_agent_rsp_fifo_out_endofpacket;                                        // po_s1_agent_rsp_fifo:out_endofpacket -> po_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_004_src_valid;                                                       // cmd_mux_004:src_valid -> po_s1_agent:cp_valid
	wire  [92:0] cmd_mux_004_src_data;                                                        // cmd_mux_004:src_data -> po_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                       // po_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [5:0] cmd_mux_004_src_channel;                                                     // cmd_mux_004:src_channel -> po_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                               // cmd_mux_004:src_startofpacket -> po_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                 // cmd_mux_004:src_endofpacket -> po_s1_agent:cp_endofpacket
	...
	wire  [16:0] rs232_s1_agent_m0_address;                                                   // rs232_s1_agent:m0_address -> rs232_s1_translator:uav_address
	...
	wire  [93:0] rs232_s1_agent_rf_source_data;                                               // rs232_s1_agent:rf_source_data -> rs232_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] rs232_s1_agent_rsp_fifo_out_data;                                            // rs232_s1_agent_rsp_fifo:out_data -> rs232_s1_agent:rf_sink_data
	...
	wire         cmd_mux_005_src_valid;                                                       // cmd_mux_005:src_valid -> rs232_s1_agent:cp_valid
	wire  [92:0] cmd_mux_005_src_data;                                                        // cmd_mux_005:src_data -> rs232_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                       // rs232_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [5:0] cmd_mux_005_src_channel;                                                     // cmd_mux_005:src_channel -> rs232_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                               // cmd_mux_005:src_startofpacket -> rs232_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                 // cmd_mux_005:src_endofpacket -> rs232_s1_agent:cp_endofpacket
	...
	wire  [92:0] nios2_debug_mem_slave_agent_rp_data;                                         // nios2_debug_mem_slave_agent:rp_data -> router_003:sink_data
	...
	wire         pi_s1_agent_rp_valid;                                                        // pi_s1_agent:rp_valid -> router_005:sink_valid
	wire  [92:0] pi_s1_agent_rp_data;                                                         // pi_s1_agent:rp_data -> router_005:sink_data
	wire         pi_s1_agent_rp_ready;                                                        // router_005:sink_ready -> pi_s1_agent:rp_ready
	wire         pi_s1_agent_rp_startofpacket;                                                // pi_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         pi_s1_agent_rp_endofpacket;                                                  // pi_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         po_s1_agent_rp_valid;                                                        // po_s1_agent:rp_valid -> router_006:sink_valid
	wire  [92:0] po_s1_agent_rp_data;                                                         // po_s1_agent:rp_data -> router_006:sink_data
	wire         po_s1_agent_rp_ready;                                                        // router_006:sink_ready -> po_s1_agent:rp_ready
	wire         po_s1_agent_rp_startofpacket;                                                // po_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         po_s1_agent_rp_endofpacket;                                                  // po_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         rs232_s1_agent_rp_valid;                                                     // rs232_s1_agent:rp_valid -> router_007:sink_valid
	wire  [92:0] rs232_s1_agent_rp_data;                                                      // rs232_s1_agent:rp_data -> router_007:sink_data
	wire         rs232_s1_agent_rp_ready;                                                     // router_007:sink_ready -> rs232_s1_agent:rp_ready
	wire         rs232_s1_agent_rp_startofpacket;                                             // rs232_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         rs232_s1_agent_rp_endofpacket;                                               // rs232_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         pi_s1_agent_rdata_fifo_src_valid;                                            // pi_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] pi_s1_agent_rdata_fifo_src_data;                                             // pi_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         pi_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_003:in_0_ready -> pi_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                           // avalon_st_adapter_003:out_0_valid -> pi_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                            // avalon_st_adapter_003:out_0_data -> pi_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                           // pi_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                           // avalon_st_adapter_003:out_0_error -> pi_s1_agent:rdata_fifo_sink_error
	wire         po_s1_agent_rdata_fifo_src_valid;                                            // po_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] po_s1_agent_rdata_fifo_src_data;                                             // po_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         po_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_004:in_0_ready -> po_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                           // avalon_st_adapter_004:out_0_valid -> po_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                            // avalon_st_adapter_004:out_0_data -> po_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                           // po_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                           // avalon_st_adapter_004:out_0_error -> po_s1_agent:rdata_fifo_sink_error
	wire         rs232_s1_agent_rdata_fifo_src_valid;                                         // rs232_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] rs232_s1_agent_rdata_fifo_src_data;                                          // rs232_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         rs232_s1_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_005:in_0_ready -> rs232_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                           // avalon_st_adapter_005:out_0_valid -> rs232_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                            // avalon_st_adapter_005:out_0_data -> rs232_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                           // rs232_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                           // avalon_st_adapter_005:out_0_error -> rs232_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_clk_clk),                             //                      clk.clk
		.reset                  (nios2_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (pi_s1_agent_m0_address),                  // avalon_universal_slave_0.address
		.uav_burstcount         (pi_s1_agent_m0_burstcount),               //                         .burstcount
		.uav_read               (pi_s1_agent_m0_read),                     //                         .read
		.uav_write              (pi_s1_agent_m0_write),                    //                         .write
		.uav_waitrequest        (pi_s1_agent_m0_waitrequest),              //                         .waitrequest
		.uav_readdatavalid      (pi_s1_agent_m0_readdatavalid),            //                         .readdatavalid
		.uav_byteenable         (pi_s1_agent_m0_byteenable),               //                         .byteenable
		.uav_readdata           (pi_s1_agent_m0_readdata),                 //                         .readdata
		.uav_writedata          (pi_s1_agent_m0_writedata),                //                         .writedata
		.uav_lock               (pi_s1_agent_m0_lock),                     //                         .lock
		.uav_debugaccess        (pi_s1_agent_m0_debugaccess),              //                         .debugaccess
		.av_address             (pi_s1_address),                           //      avalon_anti_slave_0.address
		.av_readdata            (pi_s1_readdata),                          //                         .readdata
		.av_write               (),                                        //              (terminated)
		.av_read                (),                                        //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_clk_clk),                             //                      clk.clk
		.reset                  (nios2_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (po_s1_agent_m0_address),                  // avalon_universal_slave_0.address
		.uav_burstcount         (po_s1_agent_m0_burstcount),               //                         .burstcount
		.uav_read               (po_s1_agent_m0_read),                     //                         .read
		.uav_write              (po_s1_agent_m0_write),                    //                         .write
		.uav_waitrequest        (po_s1_agent_m0_waitrequest),              //                         .waitrequest
		.uav_readdatavalid      (po_s1_agent_m0_readdatavalid),            //                         .readdatavalid
		.uav_byteenable         (po_s1_agent_m0_byteenable),               //                         .byteenable
		.uav_readdata           (po_s1_agent_m0_readdata),                 //                         .readdata
		.uav_writedata          (po_s1_agent_m0_writedata),                //                         .writedata
		.uav_lock               (po_s1_agent_m0_lock),                     //                         .lock
		.uav_debugaccess        (po_s1_agent_m0_debugaccess),              //                         .debugaccess
		.av_address             (po_s1_address),                           //      avalon_anti_slave_0.address
		.av_write               (po_s1_write),                             //                         .write
		.av_readdata            (po_s1_readdata),                          //                         .readdata
		.av_writedata           (po_s1_writedata),                         //                         .writedata
		.av_chipselect          (po_s1_chipselect),                        //                         .chipselect
		.av_read                (),                                        //              (terminated)
		.av_begintransfer       (),                                        //              (terminated)
		.av_beginbursttransfer  (),                                        //              (terminated)
		.av_burstcount          (),                                        //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_clk_clk),                             //             clk.clk
		.reset                   (nios2_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (pi_s1_agent_m0_address),                  //              m0.address
		.m0_burstcount           (pi_s1_agent_m0_burstcount),               //                .burstcount
		.m0_byteenable           (pi_s1_agent_m0_byteenable),               //                .byteenable
		.m0_debugaccess          (pi_s1_agent_m0_debugaccess),              //                .debugaccess
		.m0_lock                 (pi_s1_agent_m0_lock),                     //                .lock
		.m0_readdata             (pi_s1_agent_m0_readdata),                 //                .readdata
		.m0_readdatavalid        (pi_s1_agent_m0_readdatavalid),            //                .readdatavalid
		.m0_read                 (pi_s1_agent_m0_read),                     //                .read
		.m0_waitrequest          (pi_s1_agent_m0_waitrequest),              //                .waitrequest
		.m0_writedata            (pi_s1_agent_m0_writedata),                //                .writedata
		.m0_write                (pi_s1_agent_m0_write),                    //                .write
		.rp_endofpacket          (pi_s1_agent_rp_endofpacket),              //              rp.endofpacket
		.rp_ready                (pi_s1_agent_rp_ready),                    //                .ready
		.rp_valid                (pi_s1_agent_rp_valid),                    //                .valid
		.rp_data                 (pi_s1_agent_rp_data),                     //                .data
		.rp_startofpacket        (pi_s1_agent_rp_startofpacket),            //                .startofpacket
		...
		.rf_sink_ready           (pi_s1_agent_rsp_fifo_out_ready),          //         rf_sink.ready
		.rf_sink_valid           (pi_s1_agent_rsp_fifo_out_valid),          //                .valid
		.rf_sink_startofpacket   (pi_s1_agent_rsp_fifo_out_startofpacket),  //                .startofpacket
		.rf_sink_endofpacket     (pi_s1_agent_rsp_fifo_out_endofpacket),    //                .endofpacket
		.rf_sink_data            (pi_s1_agent_rsp_fifo_out_data),           //                .data
		.rf_source_ready         (pi_s1_agent_rf_source_ready),             //       rf_source.ready
		.rf_source_valid         (pi_s1_agent_rf_source_valid),             //                .valid
		.rf_source_startofpacket (pi_s1_agent_rf_source_startofpacket),     //                .startofpacket
		.rf_source_endofpacket   (pi_s1_agent_rf_source_endofpacket),       //                .endofpacket
		.rf_source_data          (pi_s1_agent_rf_source_data),              //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),       // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),       //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),        //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),       //                .error
		.rdata_fifo_src_ready    (pi_s1_agent_rdata_fifo_src_ready),        //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (pi_s1_agent_rdata_fifo_src_valid),        //                .valid
		.rdata_fifo_src_data     (pi_s1_agent_rdata_fifo_src_data),         //                .data
		.m0_response             (2'b00),                                   //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                     //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) pi_s1_agent_rsp_fifo (
		.clk               (clk_clk_clk),                             //       clk.clk
		.reset             (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (pi_s1_agent_rf_source_data),              //        in.data
		.in_valid          (pi_s1_agent_rf_source_valid),             //          .valid
		.in_ready          (pi_s1_agent_rf_source_ready),             //          .ready
		.in_startofpacket  (pi_s1_agent_rf_source_startofpacket),     //          .startofpacket
		.in_endofpacket    (pi_s1_agent_rf_source_endofpacket),       //          .endofpacket
		.out_data          (pi_s1_agent_rsp_fifo_out_data),           //       out.data
		.out_valid         (pi_s1_agent_rsp_fifo_out_valid),          //          .valid
		.out_ready         (pi_s1_agent_rsp_fifo_out_ready),          //          .ready
		.out_startofpacket (pi_s1_agent_rsp_fifo_out_startofpacket),  //          .startofpacket
		.out_endofpacket   (pi_s1_agent_rsp_fifo_out_endofpacket),    //          .endofpacket
		.csr_address       (2'b00),                                   // (terminated)
		.csr_read          (1'b0),                                    // (terminated)
		.csr_write         (1'b0),                                    // (terminated)
		.csr_readdata      (),                                        // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_clk_clk),                             //             clk.clk
		.reset                   (nios2_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (po_s1_agent_m0_address),                  //              m0.address
		.m0_burstcount           (po_s1_agent_m0_burstcount),               //                .burstcount
		.m0_byteenable           (po_s1_agent_m0_byteenable),               //                .byteenable
		.m0_debugaccess          (po_s1_agent_m0_debugaccess),              //                .debugaccess
		.m0_lock                 (po_s1_agent_m0_lock),                     //                .lock
		.m0_readdata             (po_s1_agent_m0_readdata),                 //                .readdata
		.m0_readdatavalid        (po_s1_agent_m0_readdatavalid),            //                .readdatavalid
		.m0_read                 (po_s1_agent_m0_read),                     //                .read
		.m0_waitrequest          (po_s1_agent_m0_waitrequest),              //                .waitrequest
		.m0_writedata            (po_s1_agent_m0_writedata),                //                .writedata
		.m0_write                (po_s1_agent_m0_write),                    //                .write
		.rp_endofpacket          (po_s1_agent_rp_endofpacket),              //              rp.endofpacket
		.rp_ready                (po_s1_agent_rp_ready),                    //                .ready
		.rp_valid                (po_s1_agent_rp_valid),                    //                .valid
		.rp_data                 (po_s1_agent_rp_data),                     //                .data
		.rp_startofpacket        (po_s1_agent_rp_startofpacket),            //                .startofpacket
		...
		.rf_sink_ready           (po_s1_agent_rsp_fifo_out_ready),          //         rf_sink.ready
		.rf_sink_valid           (po_s1_agent_rsp_fifo_out_valid),          //                .valid
		.rf_sink_startofpacket   (po_s1_agent_rsp_fifo_out_startofpacket),  //                .startofpacket
		.rf_sink_endofpacket     (po_s1_agent_rsp_fifo_out_endofpacket),    //                .endofpacket
		.rf_sink_data            (po_s1_agent_rsp_fifo_out_data),           //                .data
		.rf_source_ready         (po_s1_agent_rf_source_ready),             //       rf_source.ready
		.rf_source_valid         (po_s1_agent_rf_source_valid),             //                .valid
		.rf_source_startofpacket (po_s1_agent_rf_source_startofpacket),     //                .startofpacket
		.rf_source_endofpacket   (po_s1_agent_rf_source_endofpacket),       //                .endofpacket
		.rf_source_data          (po_s1_agent_rf_source_data),              //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_004_out_0_ready),       // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_004_out_0_valid),       //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_004_out_0_data),        //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_004_out_0_error),       //                .error
		.rdata_fifo_src_ready    (po_s1_agent_rdata_fifo_src_ready),        //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (po_s1_agent_rdata_fifo_src_valid),        //                .valid
		.rdata_fifo_src_data     (po_s1_agent_rdata_fifo_src_data),         //                .data
		.m0_response             (2'b00),                                   //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                     //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) po_s1_agent_rsp_fifo (
		.clk               (clk_clk_clk),                             //       clk.clk
		.reset             (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (po_s1_agent_rf_source_data),              //        in.data
		.in_valid          (po_s1_agent_rf_source_valid),             //          .valid
		.in_ready          (po_s1_agent_rf_source_ready),             //          .ready
		.in_startofpacket  (po_s1_agent_rf_source_startofpacket),     //          .startofpacket
		.in_endofpacket    (po_s1_agent_rf_source_endofpacket),       //          .endofpacket
		.out_data          (po_s1_agent_rsp_fifo_out_data),           //       out.data
		.out_valid         (po_s1_agent_rsp_fifo_out_valid),          //          .valid
		.out_ready         (po_s1_agent_rsp_fifo_out_ready),          //          .ready
		.out_startofpacket (po_s1_agent_rsp_fifo_out_startofpacket),  //          .startofpacket
		.out_endofpacket   (po_s1_agent_rsp_fifo_out_endofpacket),    //          .endofpacket
		.csr_address       (2'b00),                                   // (terminated)
		.csr_read          (1'b0),                                    // (terminated)
		.csr_write         (1'b0),                                    // (terminated)
		.csr_readdata      (),                                        // (terminated)
	...
	architecture_mm_interconnect_0_router router (
	...
	architecture_mm_interconnect_0_router_001 router_001 (
	...
	architecture_mm_interconnect_0_router_002 router_002 (
	...
	architecture_mm_interconnect_0_router_002 router_003 (
	...
	architecture_mm_interconnect_0_router_002 router_004 (
	...
	architecture_mm_interconnect_0_router_005 router_005 (
		.sink_ready         (pi_s1_agent_rp_ready),                    //      sink.ready
		.sink_valid         (pi_s1_agent_rp_valid),                    //          .valid
		.sink_data          (pi_s1_agent_rp_data),                     //          .data
		.sink_startofpacket (pi_s1_agent_rp_startofpacket),            //          .startofpacket
		.sink_endofpacket   (pi_s1_agent_rp_endofpacket),              //          .endofpacket
		.clk                (clk_clk_clk),                             //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	architecture_mm_interconnect_0_router_005 router_006 (
		.sink_ready         (po_s1_agent_rp_ready),                    //      sink.ready
		.sink_valid         (po_s1_agent_rp_valid),                    //          .valid
		.sink_data          (po_s1_agent_rp_data),                     //          .data
		.sink_startofpacket (po_s1_agent_rp_startofpacket),            //          .startofpacket
		.sink_endofpacket   (po_s1_agent_rp_endofpacket),              //          .endofpacket
		.clk                (clk_clk_clk),                             //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	architecture_mm_interconnect_0_router_005 router_007 (
	...
	architecture_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_clk_clk),                             //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	architecture_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_clk_clk),                             //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	architecture_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_clk_clk),                             //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	architecture_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_clk_clk),                             //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	architecture_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_clk_clk),                             //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	architecture_mm_interconnect_0_cmd_mux_003 cmd_mux_003 (
		.clk                 (clk_clk_clk),                             //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	architecture_mm_interconnect_0_cmd_mux_003 cmd_mux_004 (
		.clk                 (clk_clk_clk),                             //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	architecture_mm_interconnect_0_cmd_mux_003 cmd_mux_005 (
		.clk                 (clk_clk_clk),                             //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	architecture_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_clk_clk),                             //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	architecture_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_clk_clk),                             //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	architecture_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_clk_clk),                             //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	architecture_mm_interconnect_0_rsp_demux_003 rsp_demux_003 (
		.clk                (clk_clk_clk),                             //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	architecture_mm_interconnect_0_rsp_demux_003 rsp_demux_004 (
		.clk                (clk_clk_clk),                             //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	architecture_mm_interconnect_0_rsp_demux_003 rsp_demux_005 (
		.clk                (clk_clk_clk),                             //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	architecture_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_clk_clk),                             //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	architecture_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_clk_clk),                             //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	architecture_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	architecture_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_clk_clk),                             // in_clk_0.clk
		.in_rst_0_reset (nios2_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (pi_s1_agent_rdata_fifo_src_data),         //     in_0.data
		.in_0_valid     (pi_s1_agent_rdata_fifo_src_valid),        //         .valid
		.in_0_ready     (pi_s1_agent_rdata_fifo_src_ready),        //         .ready
	...
	architecture_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_clk_clk),                             // in_clk_0.clk
		.in_rst_0_reset (nios2_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (po_s1_agent_rdata_fifo_src_data),         //     in_0.data
		.in_0_valid     (po_s1_agent_rdata_fifo_src_valid),        //         .valid
		.in_0_ready     (po_s1_agent_rdata_fifo_src_ready),        //         .ready
